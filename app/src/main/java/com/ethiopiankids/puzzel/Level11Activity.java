...
public class Level11Activity extends  Activity { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		o2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				_cr();
				imageview1.setImageResource(R.drawable.d20230302_132929_2);
				time = new TimerTask() {
					@Override
					public void run() {
						runOnUiThread(new Runnable() {
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level11Activity.this).create();
	...
	public void _next () {
		i.setClass(getApplicationContext(), Level12Activity.class);
		startActivity(i);
		finish();
	}
