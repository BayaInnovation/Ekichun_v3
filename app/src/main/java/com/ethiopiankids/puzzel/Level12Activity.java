...
public class Level12Activity extends  Activity { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		o3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				_cor();
				imageview1.setImageResource(R.drawable.d20230302_132929_1);
				time = new TimerTask() {
					@Override
					public void run() {
						runOnUiThread(new Runnable() {
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level12Activity.this).create();
	...
	public void _prev () {
		i.setClass(getApplicationContext(), Level11Activity.class);
		startActivity(i);
		finish();
	}
	...
	public void _next () {
		i.setClass(getApplicationContext(), Level13Activity.class);
		startActivity(i);
		finish();
	}
