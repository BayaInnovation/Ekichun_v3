...
public class Level13Activity extends  Activity { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		o3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				_cor();
				imageview1.setImageResource(R.drawable.image_search_1678045056574_6);
				time = new TimerTask() {
					@Override
					public void run() {
						runOnUiThread(new Runnable() {
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level13Activity.this).create();
	...
	public void _prev () {
		ii.setClass(getApplicationContext(), Level12Activity.class);
		startActivity(ii);
		finish();
	}
	...
	public void _next () {
		ii.setClass(getApplicationContext(), Level14Activity.class);
		startActivity(ii);
		finish();
	}
