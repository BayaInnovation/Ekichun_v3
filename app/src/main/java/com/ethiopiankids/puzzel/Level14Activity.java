...
public class Level14Activity extends  Activity { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		o4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				_cor();
				imageview1.setImageResource(R.drawable.gd20230305_232601);
				time = new TimerTask() {
					@Override
					public void run() {
						runOnUiThread(new Runnable() {
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level14Activity.this).create();
