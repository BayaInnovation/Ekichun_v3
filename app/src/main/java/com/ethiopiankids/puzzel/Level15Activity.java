...
public class Level15Activity extends  Activity { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		o2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				_cor();
				imageview1.setImageResource(R.drawable.image_search_1678137399390);
				time = new TimerTask() {
					@Override
					public void run() {
						runOnUiThread(new Runnable() {
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level15Activity.this).create();
	...
	public void _prev () {
		i.setClass(getApplicationContext(), Level14Activity.class);
		startActivity(i);
		finish();
	}
	...
	public void _next () {
		i.setClass(getApplicationContext(), Level16Activity.class);
		startActivity(i);
		finish();
	}
