...
public class Level17Activity extends  Activity { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		o2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				_cor();
				imageview1.setImageResource(R.drawable.h20230305_231634);
				time = new TimerTask() {
					@Override
					public void run() {
						runOnUiThread(new Runnable() {
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level17Activity.this).create();
