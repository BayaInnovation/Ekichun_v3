...
public class Level18Activity extends  Activity { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		o4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				_cor();
				imageview1.setImageResource(R.drawable.f20230305_231508);
				time = new TimerTask() {
					@Override
					public void run() {
						runOnUiThread(new Runnable() {
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level18Activity.this).create();
