...
public class Level21Activity extends  Activity { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		o2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				_corr();
				imageview1.setImageResource(R.drawable.d20230305_231212);
				time = new TimerTask() {
					@Override
					public void run() {
						runOnUiThread(new Runnable() {
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level21Activity.this).create();
	...
	public void _prev () {
		i.setClass(getApplicationContext(), Level20Activity.class);
		startActivity(i);
		finish();
	}
	...
	public void _next () {
		i.setClass(getApplicationContext(), Level22Activity.class);
		startActivity(i);
		finish();
	}
