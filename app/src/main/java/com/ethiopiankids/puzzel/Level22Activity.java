...
public class Level22Activity extends  Activity { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		o3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				_corr();
				imageview1.setImageResource(R.drawable.image_search_1678045056574_3);
				time = new TimerTask() {
					@Override
					public void run() {
						runOnUiThread(new Runnable() {
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level22Activity.this).create();
	...
	public void _next () {
		i.setClass(getApplicationContext(), Level23Activity.class);
		startActivity(i);
		finish();
	}
