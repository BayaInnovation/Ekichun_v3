...
public class Level26Activity extends  Activity { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		o3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				_cor();
				imageview1.setImageResource(R.drawable.v20230308_135705);
				time = new TimerTask() {
					@Override
					public void run() {
						runOnUiThread(new Runnable() {
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level26Activity.this).create();
	...
	public void _next () {
		i.setClass(getApplicationContext(), Level27Activity.class);
		startActivity(i);
		finish();
	}
