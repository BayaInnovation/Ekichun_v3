...
public class Level27Activity extends  Activity { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		o1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				_cor();
				imageview1.setImageResource(R.drawable.image_search_1678220377954);
				timer = new TimerTask() {
					@Override
					public void run() {
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level27Activity.this).create();
