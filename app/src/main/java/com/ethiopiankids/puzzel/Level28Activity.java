...
public class Level28Activity extends  Activity { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		o4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				_err();
				imageview1.setImageResource(R.drawable.h20230308_135933);
				time = new TimerTask() {
					@Override
					public void run() {
						runOnUiThread(new Runnable() {
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level28Activity.this).create();
