...
public class Level2Activity extends  Activity { 
	...
	private void initializeLogic() {
		...
		error = audio.load(getApplicationContext(), R.raw.fail, 1);
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level2Activity.this).create();
	...
	public void _next () {
		i.setClass(getApplicationContext(), Level3Activity.class);
		startActivity(i);
		finish();
	}
	
	
	public void _aoudio1 () {
		error = audio.play((int)(1), 1.0f, 1.0f, 1, (int)(0), 1.0f);
	}
