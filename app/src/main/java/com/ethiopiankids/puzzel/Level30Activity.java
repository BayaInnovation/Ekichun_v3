...
public class Level30Activity extends  Activity { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		o4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				_corr();
				imageview1.setImageResource(R.drawable.image_search_1678543818367);
				time = new TimerTask() {
					@Override
					public void run() {
						runOnUiThread(new Runnable() {
	...
	private void initializeLogic() {
		...
		cor = sound.load(getApplicationContext(), R.raw.correct, 1);
	}
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level30Activity.this).create();
	...
	public void _prev () {
		i.setClass(getApplicationContext(), Level29Activity.class);
		startActivity(i);
		finish();
	}
	...
	public void _next () {
		i.setClass(getApplicationContext(), Tr3Activity.class);
		startActivity(i);
		finish();
	}
	...
	public void _corr () {
		cor = sound.play((int)(2), 1.0f, 1.0f, 1, (int)(0), 1.0f);
	}
