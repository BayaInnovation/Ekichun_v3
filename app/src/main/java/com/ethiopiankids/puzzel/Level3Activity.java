...
public class Level3Activity extends  Activity { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		o3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				_corr();
				imageview1.setImageResource(R.drawable.image_search_1675929172259);
				tim = new TimerTask() {
					@Override
					public void run() {
						runOnUiThread(new Runnable() {
	...
	private void initializeLogic() {
		...
		erro = audio.load(getApplicationContext(), R.raw.fail, 1);
		corre = audio.load(getApplicationContext(), R.raw.correct, 1);
	}
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level3Activity.this).create();
	...
	public void _err () {
		erro = audio.play((int)(1), 1.0f, 1.0f, 1, (int)(0), 1.0f);
	}
	
	
	public void _corr () {
		corre = audio.play((int)(2), 1.0f, 1.0f, 1, (int)(0), 1.0f);
	}
	
	
	public void _prev () {
		s.setClass(getApplicationContext(), Level2Activity.class);
		startActivity(s);
		finish();
	}
	...
	public void _next () {
		s.setClass(getApplicationContext(), Level4Activity.class);
		startActivity(s);
		finish();
	}
