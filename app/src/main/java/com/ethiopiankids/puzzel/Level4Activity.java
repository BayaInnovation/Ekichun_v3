...
public class Level4Activity extends  Activity { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		o3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				_corr();
				imageview1.setImageResource(R.drawable.image_search_1675929588523);
				tim = new TimerTask() {
					@Override
					public void run() {
						runOnUiThread(new Runnable() {
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level4Activity.this).create();
	...
	public void _next () {
		g.setClass(getApplicationContext(), Level5Activity.class);
		startActivity(g);
		finish();
	}
