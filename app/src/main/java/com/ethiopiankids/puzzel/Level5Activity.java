...
public class Level5Activity extends  Activity { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		o2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				_corr();
				imageview1.setImageResource(R.drawable.f20230214_160650);
				timer = new TimerTask() {
					@Override
					public void run() {
						runOnUiThread(new Runnable() {
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level5Activity.this).create();
	...
	public void _prev () {
		i.setClass(getApplicationContext(), Level4Activity.class);
		startActivity(i);
		finish();
	}
	...
	public void _next () {
		i.setClass(getApplicationContext(), Level6Activity.class);
		startActivity(i);
		finish();
	}
