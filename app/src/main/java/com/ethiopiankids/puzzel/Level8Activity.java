...
public class Level8Activity extends  Activity { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		o1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				_corr();
				imageview1.setImageResource(R.drawable.g20230222_100353);
				time = new TimerTask() {
					@Override
					public void run() {
	...
	public void _first () {
		final AlertDialog dialog1 = new AlertDialog.Builder(Level8Activity.this).create();
	...
	public void _prev () {
		i.setClass(getApplicationContext(), Level7Activity.class);
		startActivity(i);
		finish();
	}
